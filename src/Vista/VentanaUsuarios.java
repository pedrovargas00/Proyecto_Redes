...
public class VentanaUsuarios extends JFrame implements MouseListener {
    ...
    private final ImageIcon agregarContacto = new ImageIcon("src/Recursos/agregarContacto.png");
    private final ImageIcon agregado = new ImageIcon("src/Recursos/chek.png");
